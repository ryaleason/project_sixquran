                    ...
                    <div className="flex flex-wrap gap-2">
                        {qariList.map((qari) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${selectedQari === qari.id
                ...
                <div className="mt-8">
                    ...
                    <div className="space-y-6">
                        {data.ayat && data.ayat.map((ayat) => (
                            <div
                                key={ayat.nomorAyat}
                                className={`bg-white rounded-2xl p-6 shadow-sm border transition-all ${currentAyat === ayat.nomorAyat
